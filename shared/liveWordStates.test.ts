...
import { deriveLiveWordStates, firstGuidedModelWord } from "./liveWordStates";
...
describe("live transcript word tracking", () => {
  ...
  it("logs a monthly mismatch without offering retry progression", () => {
  ...
  it("identifies the first word that should trigger a guided model after two live mismatches", () => {
